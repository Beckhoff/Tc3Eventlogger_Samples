...
class CPublisherListenerCtrl : public ITcOCFCtrlImpl<CPublisherListenerCtrl, CPublisherListenerClassFactory>
{
public:
...
{
	HRESULT hr = E_FAIL;
	TRACE("PublisherListener: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CPublisherListenerCtrl>;
