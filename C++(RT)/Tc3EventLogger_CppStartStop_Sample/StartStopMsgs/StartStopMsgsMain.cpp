...
class CStartStopMsgsCtrl : public ITcOCFCtrlImpl<CStartStopMsgsCtrl, CStartStopMsgsClassFactory>
{
public:
	CStartStopMsgsCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("StartStopMsgs: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CStartStopMsgsCtrl>;
